...
from Ano import (BOT_USERNAME, DURATION_LIMIT, DURATION_LIMIT_MIN,
                   MUSIC_BOT_NAME, app, db_mem)
from Ano.Core.PyTgCalls.Converter import convert
from Ano.Core.PyTgCalls.Downloader import download
from Ano.Decorators.assistant import AssistantAdd
from Ano.Decorators.checker import checker
from Ano.Decorators.permission import PermissionCheck
from Ano.Inline import (playlist_markup, search_markup, search_markup2,
                          url_markup, url_markup2)
from Ano.Utilities.changers import seconds_to_min, time_to_seconds
from Ano.Utilities.chat import specialfont_to_normal
from Ano.Utilities.stream import start_stream, start_stream_audio
from Ano.Utilities.theme import check_theme
from Ano.Utilities.thumbnails import gen_thumb
from Ano.Utilities.url import get_url
from Ano.Utilities.youtube import (get_yt_info_id, get_yt_info_query,
...
@app.on_callback_query(filters.regex(pattern=r"Ano"))
