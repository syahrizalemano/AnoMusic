...
from Ano.Database import (is_active_chat, is_music_playing, music_off,
                            music_on, remove_active_chat)
from Ano.Decorators.admins import AdminRightsCheck
from Ano.Decorators.checker import checker, checkerCB
from Ano.Inline import audio_markup, primary_markup
...
async def admins(_, message: Message):
    ...
    if message.command[0][1] == "e":
        ...
        await Ano.pytgcalls.resume_stream(message.chat.id)
        await message.reply_text(
    ...
    if message.command[0][1] == "t" or message.command[0][1] == "n":
        ...
        await Ano.pytgcalls.leave_group_call(message.chat.id)
        await message.reply_text(
