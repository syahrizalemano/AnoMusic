...
from Ano.Core.Clients.cli import app, userbot
...
async def initiate_bot():
    ...
    header.add_column(
        "Ano Music : The Most Advanced Music Bot"
    )
    console.print(header)
    with console.status(
        "[magenta] Booting up Ano Music...",
    ) as status:
        ...
        if mango == "":
            status.update(status="[bold red] Failed to boot Ano Music!")
            console.print(
